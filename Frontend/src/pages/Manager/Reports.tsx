  ...
  return (
    <div className="relative min-h-screen w-full bg-gradient-to-br from-slate-950 via-purple-950 to-slate-900">
      ...
      <div className="border-b border-blue-500/20 pb-4 sm:pb-6">
        ...
        <p className="text-blue-200/70 mt-2">View and export team activity reports</p>
      </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-blue-200/70 mt-2">
                View daily team activity, task completions, and performance metrics
              </p>
            </div>
        ...
        <div className="glass-card rounded-2xl p-6 transition-all duration-300 hover:scale-[1.02]">
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-blue-200/70 mt-2">
                Analyze weekly trends, team productivity, and project progress
              </p>
            </div>
            <button disabled className="w-full px-4 py-2 rounded-lg border border-blue-500/30 text-blue-300/50 cursor-not-allowed text-sm font-medium">
              Coming Soon
        ...
        <div className="glass-card rounded-2xl p-6 transition-all duration-300 hover:scale-[1.02]">
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-blue-200/70 mt-2">
                Review monthly summaries, team achievements, and performance trends
              </p>
            </div>
            <button disabled className="w-full px-4 py-2 rounded-lg border border-blue-500/30 text-blue-300/50 cursor-not-allowed text-sm font-medium">
              Coming Soon
